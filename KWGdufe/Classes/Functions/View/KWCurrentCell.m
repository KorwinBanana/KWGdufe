...
//        view7.backgroundColor = [UIColor blueColor];
        ...
        _renewTimes = [[UILabel alloc]init];
        _renewTimes.font = [UIFont systemFontOfSize:14];
        [view5 addSubview:_renewTimes];
        [_renewTimes mas_makeConstraints:^(MASConstraintMaker *make) {
            make.left.equalTo(view5.mas_left).with.offset(10);
